...
if(!class_exists('SIB_Page_Statistics'))
{
    class SIB_Page_Statistics
    {
        ...
        function generate_main_page()
        {
            ...
            ?>
                <iframe id="datamain" src="https://s-my.sendinblue.com/camp/message/access_token/<?php echo $access_token; ?>" width="100%" height="750" scrolling="yes"></iframe>
        <?php
        }
        ...
        {
            ?>
            <img src="<?php echo SIB_Manager::$plugin_url . '/img/background/statistics.png'?>"  style="width: 100%;">
        <?php
