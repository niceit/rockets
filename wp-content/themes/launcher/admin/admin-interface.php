...
function siteoptions_add_admin() {
    ...
    $tt_page = add_menu_page('Launcher', 'Launcher', 'edit_theme_options', 'siteoptions','siteoptions_options_page', $icon_url = get_template_directory_uri() . '/admin/images/msetting2.png', 62);
...
<div class="wrap" id="truethemes_container">
  <div id="of-popup-save" class="of-save-popup">
    <div class="of-save-save">Settings Saved</div>
  </div>
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    <div id="header">
      <div class="logo">
		<a href="http://mythemeshop.com/" class="plogo"><img src="<?php echo get_template_directory_uri(); ?>/admin/images/logo.png" ></a>
      </div>
	  <h2>Theme Options:</h2> <span class="headtext">Trigger The Awesomness From Here!</span>
...
/*-----------------------------------------------------------------------------------*/
/* Cases for various option types
/*-----------------------------------------------------------------------------------*/
	...
	foreach ($options as $value) {
		...
		case "multicheck":
			...
			elseif( $std == $key) {
			   $checked = 'checked="checked"';
				...
				$checked = '';                                                                                    }
			$output .= '<span class="enable">Enable</span><input type="checkbox" class="checkbox of-input" name="'. $tt_key .'" id="'. $tt_key .'" value="true" '. $checked .' /><label for="'. $tt_key .'">'. $option .'</label><br />';
		...
		case "checkbox": 
		   ...
		   $checked = '';
			...
			$output .= '<span class="enable">Enable</span><input type="checkbox" class="checkbox of-input" name="'.  $value['id'] .'" id="'. $value['id'] .'" value="true" '. $checked .' />';
...
function siteoptions_uploader_function($id,$std,$mod){
	...
	$uploader .= '<div class="button image_reset_button '. $hide.'" id="reset_'. $id .'" title="' . $id . '">Remove</div>';
            $uploader .= '<input class="of-input" name="'. $id .'" id="'. $id .'_upload" type="text" value="'. $val .'" />';
	}
	
	$uploader .= '<div class="upload_button_div"><div class="button image_upload_button" id="'.$id.'">Upload Image</div></div>';
