...
<?php get_template_part('template-portfolio','Portfolio'); ?> 	
<?php get_template_part('template-team','Our Team'); ?> 	
<?php get_template_part('template-process','Our Process'); ?>
<?php get_template_part('template-services','Our Services'); ?>	
...
<?php get_template_part('template-offices','Offices'); ?>
